...
export default function Home() {
  ...
  }, [selectedProvince, getRenewableEnergyData]);

  async function getRenewableEnergyData() {
    const apiUrl = 'https://ecotecture-laravel.vercel.app/api/api/renewable';
    ...
    <main className="relative flex min-h-screen flex-col items-center justify-between">
      ...
      <div className="relative flex min-h-screen flex-col items-center justify-between py-24 px-0 my-12 z-30 w-10/12 mx-auto">
        ...
        <div className="z-10 mb-44 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
          <div className="max-w-sm rounded overflow-hidden shadow-lg">
            <div className="px-6 py-4">
              ...
              <p className="text-gray-700 font-sans text-base mb-10">
                Find out the most suitable renewable sources in your area with Weather Checker below and simulate your solar paner usage with our Solar Panel Simulator!
              </p>
              <div>
          ...
          <div className=" flex h-48 w-full items-end justify-center bg-gradient-to-t">
            <Image
              src="/pohon.png"
              alt="Vercel Logo"
              width={410}
        ...
        {/* Calculator Row */}
        <div className="z-10 mb-20 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
          <div className="max-w-lg bg-white rounded overflow-hidden shadow-lg ml-auto">
            <div className="px-6 py-6">
              ...
              <p className="text-gray-700 font-sans text-base mb-10">
                Solar panel can be 90% more efficient to use in the long run compared to regular electricity. Simulate the costs and spaces used for your solar panel!
              </p>
              <div>
        ...
        {/* Weather Checker Row */}
        <div className="z-10 mb-36 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
